...
/* ESERCIZIO 5
  ...
  */
charactersNames.forEach((element) => {
...
/* ESERCIZIO 7
  ...
  */
if (crewMass < 500) {
  console.log("la nave e sottocarico");
} else if (crewMass > 500 && crewMass < 700) {
  console.log("la nave e mettacarico");
} else if (crewMass > 700 && crewMass < 900) {
  console.log("Warning: la nave e supercarico: OVER 700");
} else if (crewMass > 900 && crewMass < 1000) {
  console.log("la nave e supercarico: OVER 900");
} else {
  console.log("DANGER! abandonare la nave subito!");
}
/* ESERCIZIO 8
...
let forloop = "gender";
let k = 0;
for (k = 0; i < starWarsCharacters.length; k++) {
...
/* --EXTRA-- ESERCIZIO 9
  ...
  */
let array = [];
array = femaleCharacters;
for (let i = 0; i < array.length; i++) {
  for (let j = 0; j < charactersNames.length; j++) {
    if (array[i].name === charactersNames[j]) {
